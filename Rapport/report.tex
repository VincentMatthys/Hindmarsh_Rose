...
\begin{center}
	\begin{tabular}{ p{0.5\textwidth}  p{0.5\textwidth} }
		\includegraphics[ width = 0.5\textwidth]{bif4.png} & \includegraphics[width = 0.5\textwidth]{bif_20.png}
	\end{tabular}
\end{center}
\caption{A gauche : diagramme de bifurcation théorique (la famille de cycle limite n'est pas représentée). A droite : diagramme de bifurcation obtenu par continuation avec \texttt{XXP-aut}}
\end{figure}
...
\begin{figure}[H]
	\begin{center}
	\includegraphics[ width = 0.7\textwidth]{I8-0_82.png}
	\end{center}
...
\end{tabular}
\end{center}
\caption{Plan de phase $w=f(v)$ pour $I_{ap} = -0.816$}
\end{figure}
