...
L'équation \ref{Stat} à 1, 2 ou 3 solution selon la valeur de $I_{ap}$, et le tableau suivant fourni un résumé des différents intervalles impliqués déterminés par la forme de $\Delta_1$ donné dans l'équation \ref{Delta1}:
\begin{center}
\begin{tabular}{|>{\centering\arraybackslash}m{3cm} | >{\centering\arraybackslash}m{1.5cm} |>{\centering\arraybackslash}m{2cm}  |c |}
\hline
...
\rowcolor{maroon!10}
$I_{ap} \in [-0.9880, -0.5672[$ & 3 & noeud stable et col et \textbf{foyer stable} \\\hline
\rowcolor{maroon!50}
$I_{ap} \approx -0.5672$ &
\multicolumn{2}{c|}{\textcolor{white}{\textbf{Bifurcation Hopf}}} \\\hline
\rowcolor{maroon!10}
...
\rowcolor{maroon!10}
$I_{ap} \in ]5/27, 7.9001[$ & 1 &  foyer instable et cycle limite stable\\\hline
\rowcolor{maroon!50}
$I_{ap} \approx 7.9001$ &
\multicolumn{2}{c|}{\textcolor{white}{\textbf{Bifurcation Hopf}}} \\\hline
\rowcolor{maroon!10}
...
\rowcolor{maroon!50}
$I_{ap} \approx -0.8161$ & \multicolumn{2}{c|}{\textcolor{white}{\textbf{Bifurcation homocline}}} \\\hline
\rowcolor{maroon!10}
$I_{ap} \in [-0.8161, -0.08560[$ & 3 & noeud stable, col et \textbf{foyer instable}\\\hline
\rowcolor{maroon!50}
$I_{ap} \approx -0.08560$ & \multicolumn{2}{c|}{\textcolor{white}{\textbf{Bifurcation Homocline}}} \\\hline
\rowcolor{maroon!10}
...
\begin{figure}[H]
	\begin{center}
		\includegraphics[width = 0.9\linewidth]{superpositionC2.png}\subcaption{Pour $c=2$ : bursting de type fold/Hopf} \includegraphics[width = 0.9\linewidth]{superpositionC1.png}\subcaption{Pour $c=1$ : bursting de type square-wave}
	\end{center}
...
\begin{figure}[htb]
	...
	\begin{subfigure}[b]{\textwidth}
		\includegraphics[angle = 270, width = 0.9\textwidth]{e_01_c_2.eps}
		\subcaption{Trace en temps de $I_{ap}$ et de $v$}
	\end{subfigure}
%
	\begin{subfigure}[b]{\textwidth}
		\includegraphics[angle = 270, width = 0.9\textwidth]{freq_c_2.eps}
		\subcaption{Fréquence de la famille de cycles limites en fonction de $I_{ap}$}
	\end{subfigure}
...
\begin{figure}[htb]\ContinuedFloat
	\centering
	\begin{subfigure}[b]{\textwidth}
		\includegraphics[angle = 270, width = 0.9\textwidth]{e_01_c_1_5.eps}
		\subcaption{Trace en temps de $I_{ap}$ et de $v$}
	\end{subfigure}
...
\begin{figure}[htb]\ContinuedFloat
	\centering
	\begin{subfigure}[b]{\textwidth}
		\includegraphics[angle = 270, width = 0.9\textwidth]{e_01_c_1_3.eps}
		\subcaption{Trace en temps de $I_{ap}$ et de $v$}
	\end{subfigure}
...
\begin{figure}[htb]\ContinuedFloat
	\centering
	\begin{subfigure}[b]{\textwidth}
		\includegraphics[angle = 270, width = 0.9\textwidth]{e_01_c_1_2.eps}
		\subcaption{Trace en temps de $I_{ap}$ et de $v$}
	\end{subfigure}
...
\begin{figure}[htb]\ContinuedFloat
	\centering
	\begin{subfigure}[b]{\textwidth}
		\includegraphics[angle = 270, width = 0.9\textwidth]{e_01_c_1.eps}
		\subcaption{Trace en temps de $I_{ap}$ et de $v$}
	\end{subfigure}
